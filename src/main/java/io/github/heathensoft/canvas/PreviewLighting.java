...
public class PreviewLighting implements Disposable {
    ...
    private static final float DEFAULT_BRIGHTNESS = 4.0f;
    private static final float DEFAULT_AMBIENCE = 0.4f;
    private static final float DEFAULT_DIFFUSE = 0.7f;
    private static final float DEFAULT_P_LIGHT = 0.0f;
    private static final Vector3f DEFAULT_POSITION = new Vector3f(-16,-16,30);
    ...
    private PreviewLighting() {
        position = new Vector3f(DEFAULT_POSITION);
        brightness = DEFAULT_BRIGHTNESS;
        pointLight = DEFAULT_P_LIGHT;
    ...
    public void uploadUniformBlock() {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()){
            ...
            uniformBuffer.bufferSubData(buffer.flip(),ATT_BLOCK_SIZE * Float.BYTES);
        }
    }
